...
if __name__ == '__main__':
	...
	a=args.bert_model+'/vocad.txt'
	## init dataset and bert model
	tokenizer = TokenizerClass.from_pretrained('E:\桌面\毕业规划以及实验代码\代码\数据\实验五\PaperClassification\FUTEX-main\specter', do_lower_case=True, clean_text=False)
