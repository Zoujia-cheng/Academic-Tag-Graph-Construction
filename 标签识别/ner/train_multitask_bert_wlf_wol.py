...
from model_multitask_bert_wlf_wol5 import MyModel
from bert import modeling as bert_modeling
from utils import DataProcessor_bert_wlf_wol as DataProcessor
from utils import load_vocabulary
from utils import extract_kvpairs_in_bioes
from utils import cal_f1_score

bert_vocab_path = "./bert_model/chinese_wobert_L-12_H-768_A-12/vocab.txt"
bert_config_path = "./bert_model/chinese_wobert_L-12_H-768_A-12/bert_config.json"
bert_ckpt_path = "./bert_model/chinese_wobert_L-12_H-768_A-12/bert_model.ckpt"

# set logging
log_file_path = "./ckpt6/run.log"
...
w2i_word, i2w_word = load_vocabulary(bert_vocab_path)
...
data_processor_train = DataProcessor(
    "./data3/train/input.seq.char",
    "./data3/train/input.seq.word",
    "./data3/train/output.seq.bio",
    "./data3/train/output.seq.attr",
    w2i_char,
    w2i_word,
    w2i_bio,
    w2i_attr,
...
data_processor_valid = DataProcessor(
    "./data3/test/input.seq.char",
    "./data3/test/input.seq.word",
    "./data3/test/output.seq.bio",
    "./data3/test/output.seq.attr",
    w2i_char,
    w2i_word,
    w2i_bio,
    w2i_attr,
