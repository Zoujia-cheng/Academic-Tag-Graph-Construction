...
w2i_char, i2w_char = load_vocabulary("./data2/vocab_char.txt")
w2i_word, i2w_word = load_vocabulary("./data2/vocab_word.txt")
w2i_bio, i2w_bio = load_vocabulary("./data2/vocab_bio.txt")
w2i_attr, i2w_attr = load_vocabulary("./data2/vocab_attr.txt")

logger.info("loading data...")

data_processor_train = DataProcessor(
    "./data2/train/input.seq.char",
    "./data2/train/input.seq.word",
    "./data2/train/output.seq.bio",
    "./data2/train/output.seq.attr",
    w2i_char,
    w2i_word,
    w2i_bio,
    w2i_attr,
...
data_processor_valid = DataProcessor(
    "./data2/test/input.seq.char",
    "./data2/test/input.seq.word",
    "./data2/test/output.seq.bio",
    "./data2/test/output.seq.attr",
    w2i_char,
    w2i_word,
    w2i_bio,
    w2i_attr,
